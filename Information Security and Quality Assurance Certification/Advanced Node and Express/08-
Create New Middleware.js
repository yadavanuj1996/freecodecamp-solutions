// NOTE: 2 changes have to be made 1st change the title value passed to index.pug from
//hello to Home Page and change the app.get request for profile to app.route().get syntax
...
.get(ensureAuthenticated,(req,res,next)=>{
  res.render(path.join(__dirname,'views','pug','profile.pug'));
});
